  ...
  return (
    <div className="flex max-w-xl flex-col gap-4">
      {section === "logo" && (
        <>
          ...
          <p className="text-sm text-muted-foreground">
            Si lo dejas vacío, se usa el logo actual (uploads/aura-logo-color-primario.png).
          </p>
      ...
      {section === "compare" && (
        <>
          <ImagePicker
            label='Foto "Antes" (comparador Antes/Después, sección "Por qué elegir Aura Studio")'
            value={form.compare_before_image ?? null}
            onChange={(url) => set("compare_before_image", url)}
          />
          <ImagePicker
            label='Foto "Después" (comparador Antes/Después, sección "Por qué elegir Aura Studio")'
